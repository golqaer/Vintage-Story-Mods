...
namespace AutoMapMarkers.Settings
{
    /// <summary>
    ...
    public static class MapMarkerConfig
    {
        ...
        public class Settings
        {
            ...
            public int ShareWaypointGroupId = -1;
            ...
            public class MapMarkerSettings_OrganicMatter
            {
                ...
                public AutoMapMarkerSetting SafeMushroom = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:safe-mushrooms"),
                ...
                public AutoMapMarkerSetting UnsafeMushroom = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:unsafe-mushrooms"),
                    markerColor: "crimson",
                    markerIcon: "mushroom",
                    markerCoverageRadius: 9);
                ...
                public AutoMapMarkerSetting WildCrop = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:wild-crops"),
                ...
                public AutoMapMarkerSetting Flower = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:flowers"),
                    markerColor: "fuchsia",
                    markerIcon: "grain",
                    markerCoverageRadius: 9);
                ...
                public AutoMapMarkerSetting Reed = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:reeds"),
                ...
                public AutoMapMarkerSetting FruitTree = new AutoMapMarkerSetting(
                    enabled: true,
                    markerTitle: Lang.Get("automapmarkers:fruit-trees"),
            ...
            public class MapMarkerSettings_DeepOre
            {
                ...
                public AutoMapMarkerSetting DeepOreCopper = new AutoMapMarkerSetting(
                    enabled: true,
                    markerTitle: Lang.Get("automapmarkers:copper-ore"),
                    markerColor: "darkorange",
                    markerIcon: "ladder",
                ...
                public AutoMapMarkerSetting DeepOreGold = new AutoMapMarkerSetting(
                    enabled: true,
                    markerTitle: Lang.Get("automapmarkers:gold-ore"),
                    markerColor: "gold",
                    markerIcon: "ladder",
                    markerCoverageRadius: 16);
                ...
                public AutoMapMarkerSetting DeepOreSilver = new AutoMapMarkerSetting(
                    enabled: true,
                    markerTitle: Lang.Get("automapmarkers:silver-ore"),
                    markerColor: "silver",
                    markerIcon: "ladder",
                    markerCoverageRadius: 16);
            ...
            public class MapMarkerSettings_Misc
            {
                ...
                public AutoMapMarkerSetting Beehive = new AutoMapMarkerSetting(
                    enabled: true,
                    markerTitle: Lang.Get("automapmarkers:beehive"),
                    markerColor: "gold",
                    markerIcon: "bee",
                    markerCoverageRadius: 1);
            ...
            public class MapMarkerSettings_Custom
            {
                ...
                public AutoMapMarkerSetting CustomMarker1 = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:custom-marker-1"),
                    markerColor: "black",
                    markerIcon: "circle",
                    markerCoverageRadius: 1);
                ...
                public AutoMapMarkerSetting CustomMarker2 = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:custom-marker-2"),
                    markerColor: "black",
                    markerIcon: "circle",
                    markerCoverageRadius: 1);
                ...
                public AutoMapMarkerSetting CustomMarker3 = new AutoMapMarkerSetting(
                    enabled: false,
                    markerTitle: Lang.Get("automapmarkers:custom-marker-3"),
                    markerColor: "black",
                    markerIcon: "circle",
                    markerCoverageRadius: 1);
            ...
            public OrderedDictionary<string, OrderedDictionary<string, AutoMapMarkerSetting>> GetMapMarkerSettingCollection()
            {
                if (_MapMarkerSettingsCollection == null)
                {
                    _MapMarkerSettingsCollection = new OrderedDictionary<string, OrderedDictionary<string, AutoMapMarkerSetting>>
                        {
                            { Lang.Get("automapmarkers:organic-matter"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                                    ...
                                    { Lang.Get("automapmarkers:safe-mushrooms"), AutoMapMarkers.OrganicMatter.SafeMushroom },
                                    { Lang.Get("automapmarkers:unsafe-mushrooms"), AutoMapMarkers.OrganicMatter.UnsafeMushroom },
                                    { Lang.Get("automapmarkers:flowers"), AutoMapMarkers.OrganicMatter.Flower },
                                    { Lang.Get("automapmarkers:fruit-trees"), AutoMapMarkers.OrganicMatter.FruitTree },
                                    { Lang.Get("automapmarkers:wild-crops"), AutoMapMarkers.OrganicMatter.WildCrop },
                                    { Lang.Get("automapmarkers:reeds"), AutoMapMarkers.OrganicMatter.Reed }
                                }
                            },
                            { Lang.Get("automapmarkers:surface-ore"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                                    ...
                                    { Lang.Get("automapmarkers:copper-ore-bits"), AutoMapMarkers.SurfaceOre.LooseOreCopper },
                                    { Lang.Get("automapmarkers:gold-ore-bits"), AutoMapMarkers.SurfaceOre.LooseOreGold },
                                    ...
                                    { Lang.Get("automapmarkers:silver-ore-bits"), AutoMapMarkers.SurfaceOre.LooseOreSilver },
                            ...
                            { Lang.Get("automapmarkers:deep-ore"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                                    ...
                                    { Lang.Get("automapmarkers:copper-ore"), AutoMapMarkers.DeepOre.DeepOreCopper },
                                    { Lang.Get("automapmarkers:gold-ore"), AutoMapMarkers.DeepOre.DeepOreGold },
                                    ...
                                    { Lang.Get("automapmarkers:silver-ore"), AutoMapMarkers.DeepOre.DeepOreSilver },
                            ...
                            { Lang.Get("automapmarkers:misc"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                                    { Lang.Get("automapmarkers:beehive"), AutoMapMarkers.MiscBlocks.Beehive },
                            ...
                            { Lang.Get("automapmarkers:traders"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                            ...
                            { Lang.Get("automapmarkers:custom"),
                                new OrderedDictionary<string, AutoMapMarkerSetting>
                                {
                                    { Lang.Get("automapmarkers:custom-marker-1"), AutoMapMarkers.Custom.CustomMarker1 },
                                    { Lang.Get("automapmarkers:custom-marker-2"), AutoMapMarkers.Custom.CustomMarker2 },
                                    { Lang.Get("automapmarkers:custom-marker-3"), AutoMapMarkers.Custom.CustomMarker3 }
                                }
                            }
                        };
                }
            ...
            public class AutoMapMarkerSetting
            {
                ...
                public int? MarkerColorInteger
                {
                    get
                    {
                        ...
                        if (MarkerColor.StartsWith("#", StringComparison.Ordinal))
                        {
                            try
                            {
                                int argb = int.Parse(MarkerColor.Replace("#", ""), NumberStyles.HexNumber);
                        ...
                        {
                            parsedColor = Color.FromName(MarkerColor);
                        }
                ...
                public string MarkerColorHex
                {
                    get
                    {
                        ...
                        {
                            var color = Color.FromName(MarkerColor);
