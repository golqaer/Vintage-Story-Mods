...
namespace AutoMapMarkers.Utilities
{
    ...
    public class ThingIdentifier
    {
        ...
        private MapMarkerConfig.Settings ModConfig
        {
            get
            {
                _Config ??= MapMarkerConfig.GetSettings(AutoMapMarkersModSystem.CoreAPI);
                return _Config;
            }
            set
            {
        ...
        private string CalculateDynamicMarkerTitleComponent()
        {
            if (BlockOrEntity is Block && BlockPosition != null)
            {
                ...
                string displayName = block.GetPlacedBlockName(AutoMapMarkersModSystem.CoreAPI.World, BlockPosition);
        ...
        private string CalculateFruitTreeName(string displayName)
        {
            ...
            var entity = AutoMapMarkersModSystem.CoreAPI.World.BlockAccessor.GetBlockEntity(BlockPosition);
        ...
        public bool MushroomNotPoisonous()
        {
            ...
            if (mushroomBlock == null)
                return false;
            IClientWorldAccessor world = AutoMapMarkersModSystem.CoreClientAPI.World;
