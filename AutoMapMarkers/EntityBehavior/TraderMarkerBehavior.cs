...
namespace AutoMapMarkers.EntityBehavior
{
                    ...
                    if (byPlayer != null)
                    {
                        ...
                        if (config != null && config.EnableMarkOnInteract)
                        {
                            ...
                            if (settings != null && entity.Pos != null)
                            {
                                ...
                                AutoMapMarkersModSystem.Network.RequestWaypointFromServer(traderPos, settings, shouldChat, config.ShareWaypointGroupId);
                            }
                        }
                    }
                }
