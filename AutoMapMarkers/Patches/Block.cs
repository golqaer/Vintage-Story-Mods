...
namespace AutoMapMarkers.Patches
{
    [HarmonyPatch]
    public class Block
    {
        ...
        private static IEnumerable<MethodBase> TargetMethods()
        {
            ...
            yield return AccessTools.Method(typeof(BlockReeds), "OnGettingBroken");
        }
        ...
        public static void Postfix(BlockSelection blockSel)
        {
            ...
            if (block is BlockTallGrass)
            {
                ...
                block = AutoMapMarkersModSystem.CoreClientAPI.World.BlockAccessor.GetBlock(blockPos);
            }
            ...
            if (shouldRequestWaypoint)
            {
                ...
                (
                    ...
                    groupId: config.ShareWaypointGroupId
                );
            }
        }
    }
