...
namespace AutoMapMarkers.BlockBehavior
{
    using static AutoMapMarkers.Settings.MapMarkerConfig;
    ...
    public class LooseOresMarkerBehavior : BlockBehavior
    {
        ...
        public void HandleInteraction(BlockPos pos, IPlayer byPlayer)
        {
            ...
            {
                Settings config = MapMarkerConfig.GetSettings(AutoMapMarkersModSystem.CoreAPI);
                if (config != null && config.EnableMarkOnInteract)
                {
                    ...
                    if (settings != null)
                    {
                        ...
                        AutoMapMarkersModSystem.Network.RequestWaypointFromServer(vecPos, settings, shouldChat, config.ShareWaypointGroupId);
                    }
                }
            }
        }
        ...
        /// </summary>
        private Settings.AutoMapMarkerSetting GetLooseOreSettings(Settings config, BlockPos blockPos)
        {
